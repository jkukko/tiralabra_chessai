...
public class BonusBoardEvaluation implements BoardEvaluation {
    ...
    public int evalueation(ChessBoard chessBoard, int player) {
        ...
        int whitePieceCount = (int) pieceList[0] + (int) pieceList[1] + (int) pieceList[2] + (int) pieceList[3] + (int) pieceList[4] + (int) pieceList[5];
        int blackPieceCount = (int) pieceList[6] + (int) pieceList[7] + (int) pieceList[8] + (int) pieceList[9] + (int) pieceList[10] + (int)pieceList[11];
